...
//  Quizzler-iOS13
//
//  Created by Nicolas Katsuji Nagano on 10/06/23.
...
struct QuizBrain{
   ...
   mutating func checkAnswer(_ userAnswer: String) -> Bool {
    ...
    func getAnswer() -> [String] { // para acessar essa funcao teria colocar quiz.getAnswer[0]. Onde dentro do colchetes irá acessar a array de string[]
